<script>
	...
	let data = [
		{ name: 'John Doe', email: 'john@email.com', phone: '+91846665646', designation: 'Engineer' },
		{
			name: 'Jane Smith',
...
<hr />
<p>1. This is testing button which is render by library</p>

<Button {classStyle} {label} />
<hr />
